...
export function DeliveryMap({ orderId, destination }: { orderId: string; destination: LatLng | null }) {
  ...
  if (!center) {
    return (
      <div className="flex h-64 items-center justify-center rounded-2xl border border-dashed border-border-default text-sm text-text-tertiary">
  ...
  return (
    <div>
      <div className="h-64 overflow-hidden rounded-2xl border border-border-subtle">
