...
export function Modal({
  ...
  return (
    <dialog
      ...
      className={`app-modal m-auto max-h-[calc(100dvh-2rem)] w-[calc(100vw-2rem)] overflow-auto ${width} rounded-modal border border-border-subtle bg-surface p-0 text-foreground shadow-md backdrop:bg-background/50`}
    >
